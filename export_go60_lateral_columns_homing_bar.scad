// Go60 - Lateral column pair with homing bar on home row
//
// Same as export_go60_lateral_columns.scad but includes extra homing bar
// keys for the R3 home row position.
//
// Order quantity: use this instead of the non-homing version for pairs
// where you want bar-style homing markers.
...
keycap_ids = [
    ...
    "cs_r3_lateral_l_bar",  // Left column homing bar
    "cs_r3_lateral_r_bar",  // Right column homing bar
];
